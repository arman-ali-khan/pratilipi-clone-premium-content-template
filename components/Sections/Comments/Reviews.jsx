            ...
            <div class="flex flex-col gap-4  p-4">
                ...
                <div class="flex justify justify-between">
                    <div class="flex gap-2 items-center">
                        <div class="w-12 flex items-center justify-center h-12 text-center rounded-full bg-yellow-500">ম</div>
                ...
                <div class="flex justify-start items-center gap-1 text-base">
                    1k
                  ...
                  Like{like?'d':''}
                    ...
                    <button class="p-1 px-2 flex items-center gap-1 text-base"><BsReply /> Reply</button>
                </div>
            </div>
        </div>
        </div>
