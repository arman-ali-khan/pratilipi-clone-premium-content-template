...
function storyId() {
  ...
  return (
    <section>
      <Navbar />
      <div className="md:p-5 mx-auto relative text-gray-800 h-56 rounded-t-xl bg-[darkblue]">
            ...
            <div className="text-left relative max-w-full min-w-56 lg:max-w-3xl w-full">
              <ul className="my-4 ml-3">
                <li className="flex flex-wrap items-center gap-3">
                  <Link className="border border-zinc-400 rounded-full px-2" href={`#`}>
                    উপন্যাস
                  </Link>
                  <Link className="border border-zinc-400 rounded-full px-2" href={`#`}>
                    সাসপেন্স - থ্রিলার
              ...
              <div className="flex items-center">
                <h2 className="text-xl w-full font-bold sm:text-xl truncate md:text-2xl">
                  অঘোর তান্ত্রিকের অঘোর তান্ত্রিকের অভিশাপ
                  খন্ডনের কাহিনি
                </h2>
                {
                    subscribed ? 
              ...
              >
                <div className="items-center flex rounded flex-col bg-base-100  px-3 py-2 w-full font-[SolaimanLipi]">
                  ...
                  <span className="hidden lg:block">অনুসরণ থেকে</span> সরান <FaCheck />
              ...
              <div className="my-4 flex   border-2 border-[darkblue] rounded-xl p-3 w-full max-w-2xl justify-between items-center">
                <div className="w-full gap-2 flex items-center h-12">
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-xs md:text-base">{convertToBengaliNumber(12)}লা অনুসরণকারী</p>
                  </div>
                </div>
              ...
              >
                <div className="items-center flex rounded flex-col bg-base-100  px-3 py-2 w-full font-[SolaimanLipi]">
                  <span className="flex items-center gap-2">
                  <span className="hidden lg:block">অনুসরণ করেছেন</span> <FaCheck />
